...
void pre_store() {
	insert_data(4755, "Nasima", "nasima15-4755@diu.edu.bd", "017111", "A+");
	insert_data(4792, "Anuradha", "anuradha15-4792@diu.edu.bd", "0171111", "A-");
	insert_data(4794, "Rakib", "rakib15-4794@diu.edu.bd", "0176763", "B+");
	insert_data(4802, "Salman", "salman15-4802@diu.edu.bd", "01664", "B-");
	insert_data(4893, "Mirajul", "mirajul15-4893@diu.edu.bd", "01766665", "O+");
	insert_data(4902, "Tanjina", "tanjina15-4902@diu.edu.bd", "0166676", "O-");
	insert_data(4903, "Tanjid", "tanjid15-4903@diu.edu.bd", "0176667", "AB+");
	insert_data(4916, "Sabbir", "sabbir15-4916@diu.edu.bd", "01678", "AB-");
	insert_data(4918, "Rumaia", "rumaia15-4918@diu.edu.bd", "0155579", "A+");
	insert_data(4928, "Jannatul", "jannatul15-4928@diu.edu.bd", "0184440", "A-");
	insert_data(4953, "Sohana", "sohana15-4953@diu.edu.bd", "0144481", "B+");
	insert_data(4982, "Jannatul", "jannatul15-4982@diu.edu.bd", "0184442", "B-");
	...
	insert_data(5643, "Kouser", "ahamed15-5643@diu.edu.bd", "01716", "B+");
}
int main() {
